...
<div class="container" class:large-container={!$sidebarOpened}>
	<h1
		class="list-header"
		style="padding-left: 62px; margin-top: 54px; font-size: 23px; font-weight: 500; text-decoration: none;"
	>
		Playlist title
	</h1>
	<div class="list-container">
		<a href="." class="vid-list">
			<a class="preview" href=".">
				<img src="/img/videoPreviews/7.png" class="thumbnail" alt="" />
			</a>
			<div class="flex-div">
				...
				<div class="list-vid-info">
					...
					<div style="display: flex; margin-top: 12px;">
						<a href="." class="vid-channel">Username &nbsp;</a><span class="betweenDot"
							>·&nbsp;</span
						>
						<p style="" id="viewsText" class="vid-views">123 views</p>
					</div>
					<p class="vid-description">No description provided</p>
				</div>
			</div>
		</a>
	</div>
