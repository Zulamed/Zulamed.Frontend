...
<div class="header">
	...
	{#if data.user.id === $user?.id}
		<MainDialog titleText="Edit your description" appealText="" descriptionText="">
			<button class="edit-btn" let:trigger use:melt={trigger} slot="button" type="button">
				<svg
					width="23"
					height="23"
					viewBox="0 0 18 18"
			...
			<form slot="ok" method="post" action="">
				<button type="submit" class="dg-btn">Save</button>
			</form>
		</MainDialog>
	{/if}
</div>
